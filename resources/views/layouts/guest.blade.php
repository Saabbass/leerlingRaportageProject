...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased light">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#F7F8FA] dark:bg-[#1C1C2E]">
            <div>
                <a href="/">
                    <x-application-logo class="w-20 h-20 fill-current text-[#333333] dark:text-[#E0E0E0]" />
                </a>
            </div>

            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-[#79b5ff] dark:bg-[#263238] text-[#333333] dark:text-[#E0E0E0] shadow-md overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
        </div>
    </body>
