<nav x-data="{ open: false }" class="bg-[#4A90E2] dark:bg-[#3B5998] border-b border-gray-100 dark:border-gray-800">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="shrink-0 flex items-center">
            <a href="/">
              <h4 class="w-auto fill-current text-[#333333] hover:text-[#50E3C2] dark:text-[#E0E0E0] hover:dark:text-[#FF6F61]">EduTrack</h4>
            </a>
          </div>
          ...
          <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            @endauth --}}
            {{-- <x-nav-link :href="route('newsposts.index')" :active="request()->routeIs('newsposts.index')">
              {{ __('Nieuws') }}
            </x-nav-link> --}}
          </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="block sm:hidden border-t border-gray-200 dark:border-gray-600">
      ...
      @auth
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
          <div class="px-4">
            <div class="font-medium text-base text-gray-800 dark:text-[#E0E0E0]">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</div>
