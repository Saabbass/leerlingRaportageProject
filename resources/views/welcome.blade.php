      ...
      <section
        ...
        <div
          ...
          <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            <x-primary-link-btn href="{{ route('dashboard') }}"
              class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-primaryLightText hover:text-primaryLightTextHover dark:text-primaryDarkText hover:dark:text-primaryDarkTextHover bg-primaryLightButton dark:bg-primaryDarkButton hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
              Ga door
