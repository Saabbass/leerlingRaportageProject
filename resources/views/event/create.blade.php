        ...
        <div class="p-6 text-[#333333] dark:text-[#E0E0E0]">
          <form action="{{ route('event.store') }}" method="POST">
            ...
            <div class="mb-4">
              ...
              <input type="datetime-local" name="subject_date_start" id="subject_date_start" value="{{ old('start_date') }}"
                class="bg-[#C8E6C9] dark:bg-[#2E3B4E] mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                required>
            </div>
            ...
            <div class="mb-4">
              ...
              <input type="datetime-local" name="subject_date_end" id="subject_date_end" value="{{ old('end_date') }}"
                class="bg-[#C8E6C9] dark:bg-[#2E3B4E] mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                required>
            </div>
